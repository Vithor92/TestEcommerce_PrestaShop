...
public class PrestaShopSiteTests extends BaseTests {
    ...
    public void testLogin_UsuarioLogadoQuandoSeusDadosForemValido(String nomeTeste
        ...
        boolean esperado_LoginCorreto;
        if(resultado.equals("positivo"))
            esperado_LoginCorreto = true;
        else
    ...
    @Test
    public void testIncluirProdutoNoCarrinho_IncluidoComSucesso() {
    ...
    @Test
    public void testIrParaCarrinho_VerificarInformacoesNaPaginaCarrinho() {
        testIncluirProdutoNoCarrinho_IncluidoComSucesso();
    ...
    @Test
    public void testIrParaCheckout_VerificarFretePagamentoEndereco() {
        testIrParaCarrinho_VerificarInformacoesNaPaginaCarrinho();
    ...
    @Test
    public void testfinalizarPedido_EsperadoPedidoFinalizadoCorretamente() {
        testIrParaCheckout_VerificarFretePagamentoEndereco();
